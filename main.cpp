...
Title		: Racing Game
Name		: Girish Patil
Install Package : sudo get-apt install libsfml-dev
To compile      : g++ -std=c++11 -Wall -Wextra -Werror main.cpp -c
To run    	: g++ -o Run main.o -lsfml-graphics -lsfml-window -lsfml-system
*************************************************************************** */
#include <iostream>
...
int main()
{
    RenderWindow app(VideoMode(width, height), "Racing Game! - Girish Patil");
